...
class Conta{
    ...
    public:
        ...
        //! Define o membro Senha presente na instância
        /*! @param Senha objeto da classe Senha*/
        void setSenha(class::Senha);
        //! Retorna o objeto Senha presente na instância
        /*! @return objeto da classe Senha*/
        class Senha getSenha() const;
};
...
class Titulo{
    ...
    public:
        ...
        class::Dinheiro getValor() const;
        //! Define o atributo CPF presente na instância
        /*! @param Cpf objeto da classe CPF*/
        void setCpf(CPF);
        //! Retorna o atributo CPF presente na instância
        /*! @return objeto da classe CPF*/
        class::CPF getCpf() const;
};
