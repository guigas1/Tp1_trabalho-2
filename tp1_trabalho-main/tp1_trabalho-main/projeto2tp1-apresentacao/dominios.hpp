...
class Percentual {
    ...
    public:
        ...
        /*! Retorna o valor inteiro armazenado pela classe Percentual*/
...
class Estado {
    ...
    public:
        ...
        //! Função getEstado
        /*! Retorna a string armazenado pela classe Estado*/
...
class Dinheiro {
    ...
    public:
        ...
        //! Função getDinheiro
        /*! Retorna o valor real armazenado no atributo Valor*/
...
class Data{
    ...
    public:
        ...
        //! Função getAno
        /*! Retorna o ano armazenado pela instância de Data*/
        /*! @return string que representa o ano armazenado*/
        string getAno() const;
        //! Função getMes
        /*! Retorna o mês armazenado pela instância de Data*/
        /*! @return string que representa o mês armazenado*/
        string getMes() const;
        //! Função getDia
        /*! Retorna o dia armazenado pela instância de Data*/
        /*! @return string que representa o dia armazenado*/
        string getDia() const;
